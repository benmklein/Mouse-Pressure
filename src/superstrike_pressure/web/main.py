"""WS-mode entry point for the Superstrike bridge."""
...
from superstrike_pressure.web.log_bus import GLOBAL_LOG_BUS
...
from superstrike_pressure.web.server import BridgeServer


def _parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run Superstrike WS bridge server")
...
def _build_launch_config(args: argparse.Namespace) -> LaunchConfig:
    env_config_dir = os.environ.get("SUPERSTRIKE_CONFIG_DIR")
