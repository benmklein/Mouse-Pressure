"""
Phase 1: Discover and sniff the Superstrike's HID reports.

VIBE CODE INSTRUCTIONS:
-----------------------
This is the most important file in Phase 1. The goal is to:

1. Enumerate all HID devices and find the Superstrike
...
The Superstrike likely exposes multiple HID interfaces:
...
def enumerate_logitech_devices():
    ...
    if not devices:
        ...
        print("Make sure the Superstrike is connected (wired or via dongle).")
        return []
