...
from mouse_pressure.web.models import CURVE_STRENGTH_MAX, CURVE_STRENGTH_MIN
...
class DevSettings:
    ...
    def as_runtime_patch(self) -> dict[str, Any]:
        channel = {
            ...
            "immediate_button_wake": self.immediate_button_wake,
            "clean_stroke_endings": self.clean_stroke_endings,
        }
        return {
            "linked": True,
...
def parse_dev_settings(
    *,
    ...
    immediate_button_wake: bool = True,
    clean_stroke_endings: bool = False,
    pressure_floor: str = "15",
    path_stabilization: str = "0",
    pressure_influence: str = "100",
    ...
    try:
        parsed = DevSettings(
            ...
            immediate_button_wake=bool(immediate_button_wake),
            clean_stroke_endings=bool(clean_stroke_endings),
