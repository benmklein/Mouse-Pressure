"""Shared HID++ pressure-stream helpers for a supported analog mouse."""
...
class PressureHidppSession:
    ...
    def open(self) -> None:
        ...
        if not self._candidates:
            raise RuntimeError(
                "No supported wired or wireless HID++ command interface was found"
            )
    ...
    def refresh_pressure_stream(self, mode: int = 0x01, mode_arg: int = 0x00) -> None:
        ...
        The supported receiver rejects the short form of this command and
