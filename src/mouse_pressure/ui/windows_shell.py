...
def set_windows_app_identity(
    app_id: str = "BenKlein.MousePressure.Driver",
) -> bool:
    """Give development launches their own taskbar identity and icon group."""
...
class SingleInstanceGuard:
    ...
    DEFAULT_NAME = r"Local\MousePressure.SingleInstance.v1"
...
class StartHotkeyListener:
    ...
    def __init__(self, callback: Any) -> None:
        ...
        self._thread = threading.Thread(
            target=self._run,
            name="mouse-pressure-start-hotkey",
            daemon=True,
        )
