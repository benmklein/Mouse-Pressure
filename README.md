...
- Sends pressure or X-tilt through Windows Ink
...
**X-tilt**. In Krita, X-tilt can control hue, size, opacity, or rotation while
the left button controls the stroke.

To configure it in Krita:

1. Open the Brush Editor with `F5`.
2. Select the brush property you want to control.
3. Choose **X-tilt** as its sensor.
